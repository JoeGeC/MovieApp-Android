...
class MovieDetailsRemoteTestProvider {
    companion object{
        ...
        val response1 = MovieDetailsResponse(movieId1, "title", "tagline", "overview", "2022-01-02", "posterId", 1.1f)
        val response2 = MovieDetailsResponse(movieId2, "title2", "tagline2", "overview2", "2022-01-02", "posterId2", 1.2f)
